...
# )
# from pipask._vendor.pip._internal.operations.install.wheel import install_wheel
from pipask._vendor.pip._internal.pyproject import load_pyproject_toml, make_pyproject_path
from pipask._vendor.pip._internal.req.req_uninstall import UninstallPathSet
...
from pipask._vendor.pip._internal.utils.packaging import safe_extra
...
class InstallRequirement:
    ...
    def install(
        ...
        # MODIFIED for pipask
        raise PipaskException("Pipask should not need to install any requirements")
        # assert self.req is not None
        # scheme = get_scheme(
        #     self.req.name,
        #     user=use_user_site,
