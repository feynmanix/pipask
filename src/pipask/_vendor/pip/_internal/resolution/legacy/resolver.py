...
from pipask._vendor.pip._internal.resolution.base import BaseResolver, InstallRequirementProvider
from pipask._vendor.pip._internal.utils import compatibility_tags
from pipask._vendor.pip._internal.utils.compatibility_tags import get_supported
